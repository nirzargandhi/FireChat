...
class ChatMessageButton: UIButton {
    var chat: ChatMessageModel?
}

class ChatSelfCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.msgAttachBgView.backgroundColor = .getChatSelfBgColor()
        ...
        self.msgAttachStackView.alignment = .trailing
    ...
    func configureCell(messageData: ChatMessageModel?) {
        
        // Media Button
        self.mediaBtn.chat = messageData
        
        // User Initial Label
        self.userInitialLabel.text = "SU"
        if !defaultUserName.isEmpty {
            self.userInitialLabel.text = getInitials(from: defaultUserName)
        }
